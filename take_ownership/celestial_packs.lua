if ClearNights.config.constellations then SMODS.Booster:take_ownership_by_kind('Celestial', {
  ...
  create_card = function(self, card, i)
    ...
    if G.GAME.used_vouchers.v_telescope and i == 1 then
      ...
      local card_set = pseudorandom_element({ 'Planet', 'CN_Constellation' }, pseudoseed('celestial' .. G.GAME.round_resets.ante))
