  ...
  descriptions = {
    Mod = {
      clearnights = {
        name = "晴夜",
        text = {
          "本模组新增两个与雨天(RainyDays)配合最佳的小型模块：",
          "——星座牌，一种全新的消耗牌。可为多种牌型提供持续整个赛局的增益。",
          "在补充包和商店中找到它们，围绕星座构筑长期的配合策略。",
          "——两副新牌组，各具独特机制，带来全新挑战，将改变你的游玩方式。"
        }
      }
    },
    ...
    Joker = ClearNights.config.constellations and {
      ...
      j_RainyDays_star_chart = {
        ...
        unlock = {
          "在一场赛局中，使用",
          "{E:1,C:attention}#1#{}张或更多的",
          "{E:1,C:cn_constellation}星座牌{}或{E:1,C:planet}星球牌{}",
        }
      },
      ...
      j_astronomer = {
        name = "天文学家",
        text = {
          "所有{C:planet}星球牌{}、{C:cn_constellation}星座牌{}",
          "和{C:planet}天体补充包{}",
      ...
      j_constellation = {
        name = "星座",
        text = {
          "每使用一张{C:cn_constellation}星座牌{}或{C:planet}星球牌{}",
    ...
    CN_Constellation = {
      c_ClearNights_aquarius = {
        name = "水瓶座",
        text = {
          "{C:attention}#1#{}及以上{C:attention}牌型{}",
          "获得{C:chips}+#2#{}筹码"
        }
      },
      ...
      c_ClearNights_capricorn = {
        ...
        text = {
          ...
          "一级获得{C:money}$#1#{}",
          "{C:inactive}(最高{C:money}$#2#{}{C:inactive}，当前{C:money}$#3#{}{C:inactive})",
        }
      },
      ...
      c_ClearNights_gemini = {
        ...
        text = {
          "生成本赛局中",
          "上一次使用的",
          "{C:cn_constellation}星座牌{}",
          "不包括{s:0.8,C:cn_constellation}双子座{s:0.8}"
        }
      },
      ...
      c_ClearNights_virgo = {
        ...
        text = {
          "将等级最低的",
          "{C:attention}牌型{}提升{C:attention}#1#{}级"
        }
      }
    },
    ...
    Voucher = {
      ...
      v_planet_merchant = ClearNights.config.constellations and {
        ...
        text = {
          "商店内",
          "{C:cn_constellation}星座牌{}和{C:planet}星球牌{}",
      ...
      v_planet_tycoon = ClearNights.config.constellations and {
        ...
        text = {
          "商店内",
          "{C:cn_constellation}星座牌{}和{C:tarot}星球牌{}",
          "出现频率{C:attention}X#1#{}",
        }
      } or nil
    },
    ...
    Other = {
      clearnights_ivory_seal = {
        ...
        text = {
          "如果在本回合的",
          "{C:attention}第一手{}或{C:attention}第二手{}打出",
          "生成一张{C:cn_constellation}星座牌{}",
          "{C:inactive}(必须有空位)"
        }
      },
      ...
      p_celestial_jumbo = ClearNights.config.constellations and {
        name = "巨型天体包",
        text = {
          "从最多{C:attention}#2#张{C:cn_constellation}星座牌{}或{C:planet}星球牌{}中",
          "选择{C:attention}#1#{}张",
          "即选即用",
        }
      } or nil,
      ...
      p_celestial_mega = ClearNights.config.constellations and {
        name = "超级天体包",
        text = {
          "从最多{C:attention}#2#张{C:cn_constellation}星座牌{}",
          "或{C:planet}星球牌{}中选择",
